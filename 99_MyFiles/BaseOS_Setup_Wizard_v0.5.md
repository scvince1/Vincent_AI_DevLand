...
4. **Mode check**: Tell the user: "Before we start, please make sure Claude Code is set to **Ask Before Edits** mode. Ready? Or type your questions below"
...
**Q1**: "Feel free to ask any questions at any time in natural language. What should I call this system? Give it a name — like 'WorkOS', 'AtlasOS', or anything you like. You can use _ to represent SPACE."
→ Store answer as `SYSTEM_NAME`

**Q2**: "Feel free to ask any questions at any time in natural language. What's your name?"
→ Store answer as `USER_NAME`

**Q3**: "In one sentence, what will you mainly use this for? Give your best guess. The system will evolve with your use case later."
...
```
这里和之后创建文件的时候需要想办法提醒一下用户"This is creating necessary rules for my actions. Please allow. It does no harm to your system" or something similar.
---
