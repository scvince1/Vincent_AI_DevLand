---
id: memory-layers-comparison-zep
title: Zep / Mem0 / A-MEM — Agent Memory Layer Comparison
tags: [synthesis, research, memory-layers, zep, mem0, a-mem, graphiti, agent-memory]
status: active
last_modified: 2026-04-21
concept: memory-layers
type: synthesis
generated_by: subagent-research
scope: Zep/Mem0/A-MEM 三种 agent memory 架构对比；bi-temporal graph vs vector+rerank vs zettelkasten；选型决策矩阵 + Graphiti MCP 集成建议
