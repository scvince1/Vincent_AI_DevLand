---
id: vibe-kanban-architecture
title: Vibe Kanban 架构逆向分析
tags: [synthesis, research, vibe-kanban, claude-code, harness-engineering, rust, worktree]
status: active
last_modified: 2026-04-21
concept: vibe-kanban
type: synthesis
generated_by: subagent-research
scope: BloopAI/vibe-kanban repo 逆向分析：spawn 机制、worktree 隔离、stdin/stdout 通信协议、session 续接与完成检测设计
