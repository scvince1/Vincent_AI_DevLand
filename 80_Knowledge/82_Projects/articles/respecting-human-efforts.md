---
id: respecting-human-efforts
title: "Respecting Human Efforts: What Karpathy's LLM Wiki Doesn't Say"
tags: [article, published, thought-leadership, knowledge-systems, respecting-efforts, human-judgment]
status: published
...
summary: A historian's account of building three knowledge systems on Karpathy's LLM Wiki pattern — and why the architecture that retrieves well still fails the humans it serves unless it is shaped around Human Sloppiness (we know more than we can tell; we need more than we can describe) and Human Efforts (the unified judgment mechanism that cannot be decomposed).
